...
if __name__ == "__main__":
    # Import data
    litqa2_test_data = pd.read_parquet("/root/paperQA2_analysis/data/LitQA_data/full_valid.parquet")
    ...
    paperqa_settings = Settings(
        ...
        batch_size=1,
        verbosity=1,
        paper_directory="/root/paperQA2_analysis/data/LitQA_data/LitQA2_valid_pdfs"
    )
